...
SELECT
  ...
  cm.ad_name AS cust_nm,
  cm.ad_name AS cust_nm_en,
  cm.ad_type AS cust_type_cd,
  cm.ad_type AS cust_type_nm,
  ...
  cm.ad_sort AS sort_field,
  cm.ad_tax_usage AS tax_juris_cd,
  ...
  cm.ad_vat_reg AS vat_regstr_nbr,
  ...
  cm.ad_email AS cust_email_addr_txt,
  ...
  cm.ad_phone AS phn_nbr1,
  cm.ad_phone2 AS phn_nbr2,
