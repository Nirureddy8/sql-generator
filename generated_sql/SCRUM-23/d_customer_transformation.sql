...
_source AS (
    SELECT 
        ...
        ad_mstr.ad_userid,
        cm_mstr.cm_mod_date
    FROM edp_raw.sap_hana.cm_mstr cm_mstr
    LEFT JOIN edp_raw.sap_hana.ad_mstr ad_mstr
        ON UPPER(cm_mstr.cm_addr) = UPPER(ad_mstr.ad_addr) 
        AND UPPER(cm_mstr.cm_domain) = UPPER(ad_mstr.ad_domain)
    LEFT JOIN edp_raw.sap_hana.currency currency
        ON currency.currencycode = cm_mstr.cm_curr
    JOIN edp_raw.sap_hana.d_cntry_hier d_cntry_hier
...
_transformed AS (
    SELECT 
        ...
        CONCAT('msd_qad_', LOWER(ad_domain), '|', d_cntry_hier.cntry_hier_key) AS deflt_delvr_cntry_key,
