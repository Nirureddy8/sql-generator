-- Query: dim_customer_cte
-- Purpose: Generate the d_customer dimension table by transforming and joining source tables based on the mapping document.
-- Query Type: SELECT
...
WITH cte_base_data AS (
    SELECT
        ...
        END AS inter_co_cd
    FROM
        tfsdl_aig_qad_delta.cm_mstr cm_mstr
