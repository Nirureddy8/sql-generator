...
-- Pattern: dimension_flat
-- Coverage: 168 rows
-- WARNING: unresolved items: No source_table or source_field provided for any field. All fields defaulted to NULL.; No source_table or source_field provided for any field. All expressions defaulted to CAST(NULL AS string).
