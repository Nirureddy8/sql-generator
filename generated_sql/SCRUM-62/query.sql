...
-- Pattern: dimension_flat
-- Coverage: 168 rows
-- WARNING: unresolved items: No source_table or source_field provided for any field in FIELD MAPPINGS.; No source_table or source_field provided for any field. All fields defaulted to CAST(NULL AS string).
...
FROM /* TODO: source table */ unknown_source src